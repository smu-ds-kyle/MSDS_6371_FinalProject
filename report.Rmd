...
No patterns or clustering are observed in the residuals versus fitted values plot (Figure 6), which that residuals are not correlated.
...
No patterns or unusual  are visible in the residuals plot (shown in Figure 10), which supports the assumption of independence.
